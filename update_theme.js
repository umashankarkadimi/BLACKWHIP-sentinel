...
const replacements = [
  ...
  // bg colors
  { pattern: /bg-\[\#FDFBF7\]/g, replacement: 'bg-[#0f172a]' }, // slate-900
  { pattern: /bg-white\/90/g, replacement: 'bg-[#1e293b]/90' }, // slate-800
  ...
  // Severity pill styling - let's make them vibrant
  { pattern: /bg-red-100 text-fuchsia-400 border border-fuchsia-500\/30/g, replacement: 'bg-rose-500/20 text-rose-400 border border-rose-500/50' },
  { pattern: /bg-orange-100 text-slate-300 border border-violet-500\/30/g, replacement: 'bg-orange-500/20 text-orange-400 border border-orange-500/50' },
  { pattern: /bg-amber-100 text-slate-300 border border-violet-500\/30/g, replacement: 'bg-amber-500/20 text-amber-400 border border-amber-500/50' },
  { pattern: /bg-blue-100 text-slate-300 border border-violet-500\/30/g, replacement: 'bg-blue-500/20 text-blue-400 border border-blue-500/50' },
];
